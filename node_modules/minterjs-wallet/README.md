...
[![Build Status](https://img.shields.io/github/workflow/status/MinterTeam/minterjs-wallet/Test?label=test&style=flat-square)](https://github.com/MinterTeam/minterjs-wallet/actions/workflows/test-with-coverage.yml)
...
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg?style=flat-square&label=license)](https://github.com/MinterTeam/minterjs-wallet/blob/master/LICENSE)

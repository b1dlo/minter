 ...
 * @return {HDKey}
 */
export function hdKeyFromSeed(seed, path = {}) {
 ...
 * @constructor
 */
const Wallet = function WalletConstructor(priv, mnemonic, doAsync, hdPath) {
    if (priv && mnemonic) {
    ...
    if (mnemonic && doAsync) {
        return seedFromMnemonicAsync(mnemonic)
            .then((seed) => {
                this._privKey = hdKeyFromSeed(seed, hdPath)._privateKey;
 ...
 * @return {Wallet}
 */
export function generateWallet(path) {
 ...
 * @return {Wallet}
 */
export function walletFromMnemonic(mnemonic, path) {
 ...
 */
export function walletFromMnemonicAsync(mnemonic, path) {
